...
-- Dumping data for table dblaporansiswa.hubungan: ~4 rows (approximately)
...
-- Dumping data for table dblaporansiswa.ortu: ~4 rows (approximately)
REPLACE INTO `ortu` (`idortu`, `nik`, `nama`, `pendidikan`, `pekerjaan`, `telp`, `alamat`, `jk`, `agama`, `is_active`) VALUES
	...
	(7, '10071987', 'Ramadhan', 'S1 Sastra Inggris', 'PNS', '081238123', 'BJM', 'L', 'Islam', 'Aktif');
...
-- Dumping data for table dblaporansiswa.poin: ~14 rows (approximately)
...
-- Dumping data for table dblaporansiswa.semester: ~0 rows (approximately)
...
-- Dumping data for table dblaporansiswa.siswa: ~3 rows (approximately)
...
-- Dumping data for table dblaporansiswa.wali_kelas: ~3 rows (approximately)
...
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40111 SET SQL_NOTES=IFNULL(@OLD_SQL_NOTES, 1) */;
>>>>>>> 118151da5a92dd223e6b346670140b22fc2c28a0

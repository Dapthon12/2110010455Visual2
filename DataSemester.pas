...
and (edt3.Text= ZQuery1.Fields[8].AsString)and (edt4.Text= ZQuery1.Fields[9].AsString)
and (edt5.Text= ZQuery1.Fields[10].AsString) and (dtp1.Date= ZQuery1.Fields[11].AsDateTime)
